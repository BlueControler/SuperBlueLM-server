...
class ScopedConfig(BaseModel):
    ...
    github_repo: str = "BlueControler/SuperBlueLM-server"
...
cfg = Config(
    watchdog=ScopedConfig(
        github_repo=os.getenv("WATCHDOG__GITHUB_REPO", "BlueControler/SuperBlueLM-server"),
        github_branch=os.getenv("WATCHDOG__GITHUB_BRANCH", "main"),
        github_token=os.getenv("WATCHDOG__GITHUB_TOKEN", ""),
        poll_interval=int(os.getenv("WATCHDOG__POLL_INTERVAL", "30")),
    )
).watchdog
